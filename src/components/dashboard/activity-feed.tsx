  ...
  return (
    <section className="border-border bg-card rounded-xl border">
      <header className="border-border flex items-center justify-between border-b px-5 py-4">
        ...
        {/* There's no dedicated "all activity" page this could link to —
            the feed already caps at 50 loaded items (see the dashboard
            page's loadActivity(db, 50, ...) call), and the footer's page-
            size buttons already reveal all of them in place. This used to
            be a Link to /inbox, which only ever covered the "message"
            kind of activity item and made no sense for a deal/contact/
            broadcast/automation row — jump to the max page size instead
