...
const ACTIONS: Action[] = [
  ...
  { labelKey: 'newDeal', href: '/pipelines', icon: Briefcase, tint: 'text-blue-600 dark:text-blue-400' },
  { labelKey: 'newBroadcast', href: '/broadcasts/new', icon: Radio, tint: 'text-amber-600 dark:text-amber-400' },
