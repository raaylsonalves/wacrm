...
export async function GET(
  ...
  // Read-only, but still account-scoped: `viewer` is enough to open
  // an automation, not just the teammate who happened to create it.
  let ctx
  try {
...
export async function PATCH(
  ...
  // Account-scoped check before we touch anything — any agent+ on the
  // account may edit it, not only whoever originally created it. Load
  // the fields we need to compute the post-patch "effective" state for
  // validation.
